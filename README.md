...
💼 Availability: Open for freelance contracts and remote roles via Upwork
⚡ Core Focus: Secure web applications, backend automation, and algorithmic trading scripts (MQL5)
🛠️ Tech Stack & Tools
Languages: JavaScript, Python, C++, HTML/CSS, SQL
Frameworks & Libs: React, Next.js
Specialized Platforms: MetaTrader 5 (MQL5), Git, VS Code
